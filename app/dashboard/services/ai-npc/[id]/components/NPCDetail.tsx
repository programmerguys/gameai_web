  ...
  return (
			<div className="space-y-8">
				...
				<div className="grid gap-6 grid-cols-1 md:grid-cols-2">
					...
					/>
					{/* 动作卡片 */}
					<Card className="border-emerald-200/50 shadow-sm md:col-span-1">
										...
										>
											<div className="flex justify-between items-center">
												...
												<div className="flex items-center gap-2">
													...
													<ChevronRight
														className={`h-4 w-4 text-muted-foreground transition-transform ${expandedAction === action.name ? "rotate-90" : ""}`}
													/>
												</div>
											</div>
											<p className="text-sm text-muted-foreground mt-1">
											...
											{expandedAction === action.name &&
												...
												Object.keys(action.parameters).length > 0 && (
													<div className="mt-3 pt-3 border-t border-emerald-100">
														<h5 className="text-xs font-medium mb-2 text-emerald-700">
															参数列表:
														</h5>
														<div className="bg-white/50 rounded-md border border-emerald-100/80 overflow-hidden">
															<table className="w-full text-xs">
																<thead className="bg-emerald-50">
																	<tr>
																		<th className="py-2 px-3 text-left font-medium text-emerald-800">
																			参数名
																		</th>
																		<th className="py-2 px-3 text-left font-medium text-emerald-800">
																			描述
