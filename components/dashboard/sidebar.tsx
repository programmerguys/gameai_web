    ...
    <aside className="w-64 h-screen border-r border-border bg-card sticky top-0 left-0 py-5 flex flex-col">
      ...
      <nav className="flex-1 space-y-1 px-3">
        ...
        <NavItem 
          ...
          label="3D模型生成"
          isActive={pathname === '/dashboard/services/model-generator'}
        />
        ...
        <NavItem 
          ...
          label="创意点子生成"
          isActive={pathname === '/dashboard/services/idea-generator'}
        />
        ...
        <NavItem 
          ...
          label="代码生成"
          isActive={pathname === '/dashboard/services/code-generator'}
        />
        ...
        <NavItem 
          ...
          label="AI NPC"
          isActive={pathname.startsWith('/dashboard/services/ai-npc')}
        />
